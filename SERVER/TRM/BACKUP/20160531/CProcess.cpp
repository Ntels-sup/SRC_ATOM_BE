...
//	char hexec_yn				 [2];
//	char hstart_order			 [11];
//	char hstop_order			 [11];
	char huse_yn				 [2];
//	char hnorm_stop_cd			 [11];
//	char hresta_reset_sec		 [11];
//	char hresta_cnt				 [11];
    char hproc_type				 [2];
...
//	memset(hexec_yn, 0, 2);
//	memset(hstart_order, 0, 11);
//  memset(hstop_order, 0, 11);
	memset(huse_yn, 0, 2);
//	memset(hnorm_stop_cd, 0, 11);
//	memset(hresta_cnt, 0, 11);
...
//  f.Set(hexec_yn,        sizeof(hexec_yn));       
//	f.Set(hstart_order,    sizeof(hstart_order));   
//  f.Set(hstop_order,     sizeof(hstop_order));    
	f.Set(huse_yn,         sizeof(huse_yn));        
//  f.Set(hnorm_stop_cd,   sizeof(hnorm_stop_cd));  
//  f.Set(hresta_cnt,      sizeof(hresta_cnt));    
...
//    	strncpy(stProcessPtr->exec_yn,        hexec_yn,        sizeof(hexec_yn));
//	    stProcessPtr->start_order = atoi(hstart_order);
//    	stProcessPtr->stop_order  = atoi(hstop_order);
	    strncpy(stProcessPtr->use_yn,         huse_yn,         sizeof(huse_yn));
//	    stProcessPtr->norm_stop_cd = atoi(hnorm_stop_cd);
//	    stProcessPtr->resta_cnt = atoi(hresta_cnt);    
...
//		g_pcLog->INFO("%d, %s, %s, %s, %d, %s, %s, %s, %s, %d, %d, %s, %d, %d, %s, %s", 
...
//                                stProcessPtr->exec_yn,
//                                stProcessPtr->start_order,
//                                stProcessPtr->stop_order,
                                stProcessPtr->use_yn,
//                                stProcessPtr->norm_stop_cd,
//                                stProcessPtr->resta_cnt,
...
int CProcess::ProcSelect(ST_PROCESS *a_process)
{
