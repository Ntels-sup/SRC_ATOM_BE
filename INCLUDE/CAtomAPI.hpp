...
class ATOM_API
{
	private :
		...
		char m_szErrorMsg[DEF_MEM_BUF_1024];
		...
		//Process Error Msg
		void SetErrorMsg(int a_nErrCode, const char *a_szMsg);
	...
	public:
		...
		//Stat
		int SendStat(time_t a_tTime, char *a_szTable, vector<string> &a_vecPri, vector<int> &a_vecData, bool a_bHist = false);
