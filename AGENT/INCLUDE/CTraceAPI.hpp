...
public:
	...
	int			 GetTraceRequest(CProtocol *a_pclsReqProtocol, CProtocol *a_pclsResProtocol);
	int			 SetTraceResponse(CProtocol *a_pclsResProtocol, ST_TRACE_REQUEST *a_tracerequest, bool a_bRet);
	void 		SetTraceData(CProtocol *a_pclsResProtocol, int a_nIdx, bool a_bRet, string a_strData);
