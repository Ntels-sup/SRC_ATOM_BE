...
class RSAMsg
{
	...
	public:
		...
		~RSAMsg();
		int Initialize();
		// cjr_20160610 a_pclsMain Add
		int ProcessCmd(CProtocol* a_pclsProto, time_t a_tCur, RESOURCE *a_pstRsc, int a_nGroupCnt, void* a_pclsMain);
		...
		// cjr_20160610 a_pclsMain Add
		int ProcessPeerIpCommand(CProtocol *a_pclsProto, RESOURCE *a_pstRsc, int a_nGroupCnt, void* a_pclsMain);
